...
//                     // delete the replies
//                     updateMany: {
//                         'filter': { totalRepliesAndComments: { $gt: 0 } },
//                         'update':
//                         {
//                             $pull: {
...
//     it('will delete all reply likes by deleted user', done => {
//         BlogPost.findOne({ _id: '3e4eaf94-ef59-4e7b-a7d2-e7f0b6115e76' })
//             .then(post => {
//                 const targetComment = post.comments.find(({ commentId }) => commentId === '2c305eed-c5ea-4a23-9ad3-03d501a2aec6');
//                 const targetReply = targetComment.replies.find(({ replyId }) => replyId === 'dc078f7f-faaa-4acf-a2c0-2b669cbe4ec4');
//                 const isDeletedUserLikesPresent = !targetReply.userIdsOfLikes.filter(({ userId }) => userId === userToDeleteId).length
//                 assert.equal(isDeletedUserLikesPresent, true);
//                 done();
//             })
//             .catch(error => {
//                 if (error) {
//                     console.error('Reply likes of deleted user is still present: ', error);
//                     assert.fail();
//                 }
//             })
//     })
...
//     before(done => {
//         userToDelete = new User({ id: 'd912e3db-d8ff-4a7f-aba7-6433170ca10c' })
//         userToDelete.save()
//             .then(() => {
